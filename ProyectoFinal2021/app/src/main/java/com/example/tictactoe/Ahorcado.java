...
public class Ahorcado extends AppCompatActivity {
    ...
    private LinearLayout wordLayourt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wordLayourt = findViewById(R.id.words);
    ...
    private void playGame(){
        ...
        for(int i = 0; i<currWord.length(); i++){
            ...
            wordLayourt.addView(charViews[i]);
    ...
    public void letterPressed(View view){
        ...
        if(correct){
            ...
            builder.setMessage("mejor suerte la proxima sempai! \n respuesta \n" + currWord);
            builder.setPositiveButton("Jugar de nuevo", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Ahorcado.this.playGame();
